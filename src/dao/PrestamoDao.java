...
public class PrestamoDao implements IPrestamoDao {
    ...
    public int PedirPrestamo(Prestamo prestamo) {
        ...
        try (PreparedStatement statement = conexion.prepareStatement("INSERT INTO prestamo (numeroCuenta, importePedido, importexmes, cuotas, fechaPedido, estado) VALUES (?, ?, ?, ?, ?, ?)", PreparedStatement.RETURN_GENERATED_KEYS)) {
    ...
    public Prestamo ObtenerPrestamoPorId(int idPrestamo) {
        ...
        try (PreparedStatement statement = conexion.prepareStatement("SELECT p.*, " +
                ...
                "pr.nombre AS provinciaDescripcion " +
                "FROM prestamo p " +
                "JOIN cuenta c ON p.numeroCuenta = c.numero " +
                "JOIN cliente cl ON c.idCliente = cl.idCliente " +
                "JOIN tiposcuenta tc ON c.idTipoCuenta = tc.idTipoCuenta " +
