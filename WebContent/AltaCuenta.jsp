...
<body>
    <div class="container">
        <div>
            ...
            if (advertencia != null) {
            %>
            <div class="alert alert-<%=advertencia.equals("exito") ? "success" : "danger"%>">
                <strong><%=advertencia.equals("exito") ? "Éxito" : "Error"%>!</strong>
                <%=(advertencia.equals("exito") ? "La cuenta se ha agregado exitosamente." : "El cliente ya posee 3 cuentas.")%>
            </div>
            <%
            }
            %>
